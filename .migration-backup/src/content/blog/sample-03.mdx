---
title: How to Integrate Markdown and MDX into Your Next.js Project
...
```tsx showLineNumbers title="mdx-components.tsx"
...
```js showLineNumbers title="mdx-components.js"
...
```mdx title="markdown/welcome.mdx" showLineNumbers
import { MyComponent } from 'my-component';
...
```tsx title="app/mdx-page/page.tsx" showLineNumbers
...
```jsx title="app/mdx-page/page.js" showLineNumbers
import Welcome from '@/markdown/welcome.mdx';
...
<Image
  src="/images/undraw/image-01.png"
  width="1598"
  height="1236"
  alt="Image"
/>
...
```jsx title="app/blog/[slug]/page.js" showLineNumbers
...
```js title="mdx-components.js" showLineNumbers
...
```tsx title="app/mdx-page/layout.tsx" showLineNumbers
...
```jsx title="app/mdx-page/layout.js" showLineNumbers
...
```jsx title="app/blog/page.js" showLineNumbers
import BlogPost, { metadata } from '@/content/blog-post.mdx';
...
```jsx title="app/mdx-page-remote/page.js" showLineNumbers
import { MDXRemote } from 'next-mdx-remote-client/rsc';
